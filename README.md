...
- On every push to `release`, semantic-release evaluates conventional commits and creates the next GitHub Release with a semantic version tag (for example `v2.1.0`).
